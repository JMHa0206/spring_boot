...
public class ResourceDTO {
	...
	private String resc_location;
	private String resc_status;
	private String resc_description;
	
	public ResourceDTO() {}
	
	public ResourceDTO(int resc_id, String resc_name, int resc_type_id, int resc_capacity, String resc_location,
		...
		this.resc_location = resc_location;
	...
	public String getResc_location() {
		return resc_location;
	}

	public void setResc_location(String resc_location) {
		this.resc_location = resc_location;
	}
